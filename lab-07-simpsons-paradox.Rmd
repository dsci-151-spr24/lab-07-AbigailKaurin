...
***This data was from an observational study, there was no assigned treatment groups for people***
...
***This does not meet what I expected to happen. It appears that those who smoke have a higher probability of being alive 20 years later***
...
Whickham = Whickham %>%
  mutate(age_cat = cut(age, breaks = c(0, 44, 64, 85), labels = c("18-44", "45-64", "65+") ))
...
***In the plot it appears that smokers have a higher probability of being dead in each age category***
